...
function baselineFixture(): unknown {
  // PROVENANCE (controller, 2026-07-02): this fixture was generated by post-change
  // code (review finding C). True preservation was then proven independently:
  // pre-change engine (worktree @056b9a2) vs current across 8 seeds
  // {1,42,777,9000,12345,20000,31415,55555} -> 8/8 byte-identical plans.
