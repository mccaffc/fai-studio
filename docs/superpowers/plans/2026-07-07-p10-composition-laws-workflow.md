...
3. **Destination export presets:** the export row gains a preset select — Hero 2560×1280 PNG (banner 6×3 @2×), Deck panel 1920×960 PNG, Eyebrow 3840×640 PNG (from strip 3×1 @3×), Square social 2048×2048 (square 3×3) — named for where they land (website hero, deck panel/eyebrow per the deck-kit). Preset implies arrangement: choosing a preset with a mismatched current arrangement regenerates same-seed in the right arrangement first.
