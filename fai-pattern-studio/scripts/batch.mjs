...
const jobs = [
  ...
  { name: "duotone-bw", cfg: { seed: 505, arrangement: "banner", color: { mode: "duotone" } } },
  { name: "vertical-blue", cfg: { seed: 606, arrangement: "banner", color: { mode: "vertical", accent: "#4997D0" } } },
  { name: "vertical-yellow", cfg: { seed: 707, arrangement: "banner", color: { mode: "vertical", accent: "#FFA300" } } },
  { name: "full-banner-e", cfg: { seed: 808, arrangement: "banner", color: { mode: "full" } } },
  ...
  { name: "tri-only", cfg: { seed: 1515, arrangement: "banner", categories: ["triangles"], color: { mode: "vertical", accent: "#FF4F00" } } },
